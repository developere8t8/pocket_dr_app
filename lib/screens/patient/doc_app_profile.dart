...
class DocAppProfile extends StatefulWidget {
  const DocAppProfile({super.key});

  @override
  State<DocAppProfile> createState() => _DocAppProfileState();
}

class _DocAppProfileState extends State<DocAppProfile> {
  @override
                    ...
                    children: [
                      ...
                      Center(
                        child: SizedBox(
                          ...
                          height: 49.h,
                          child: FixedPrimary(
                              buttonText: 'Message Now(Start11:00AM)',
                              ontap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
