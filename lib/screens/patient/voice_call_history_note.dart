...
class VoiceCallHistoryNote extends StatefulWidget {
  const VoiceCallHistoryNote({Key? key}) : super(key: key);

  @override
  State<VoiceCallHistoryNote> createState() => _VoiceCallHistoryNoteState();
}

class _VoiceCallHistoryNoteState extends State<VoiceCallHistoryNote> {
  bool visibl = false;
