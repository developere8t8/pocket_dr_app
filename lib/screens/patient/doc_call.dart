...
import 'package:pocket_gp_app/screens/patient/incoming_call.dart';
...
class DocCall extends StatefulWidget {
  const DocCall({super.key});

  @override
  State<DocCall> createState() => _DocCallState();
}

class _DocCallState extends State<DocCall> {
  @override
                    ...
                    children: [
                      ...
                      Center(
                        child: SizedBox(
                          ...
                          height: 49.h,
                          child: FixedPrimary(
                              buttonText: 'Call Now(Start11:00AM)',
                              ontap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
