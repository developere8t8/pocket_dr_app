...
class FAQscreenDoc extends StatefulWidget {
  const FAQscreenDoc({Key? key}) : super(key: key);

  @override
  State<FAQscreenDoc> createState() => _FAQscreenDocState();
}

class _FAQscreenDocState extends State<FAQscreenDoc> {
  @override
